...
namespace RecipesAPI.Repositories.Ingredients
{
    public class LocalImageRepository : IImageRepository
    {
        ...
        public async Task<Image> Upload(Image image)
        {
            ...
            var urlFilePath = $"{httpContextAccessor.HttpContext.Request.Scheme}://{httpContextAccessor.
            HttpContext.Request.Host}{httpContextAccessor.HttpContext.Request.PathBase}/Images/{image.FileName}{image.FileExtension}";
